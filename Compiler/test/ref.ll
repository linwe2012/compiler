...
%struct.Ch = type { i32 }
%struct.A = type { i32, i8, double, %struct.D, %union.U }
...
entry:
  ...
  call void @dummy2(i32 8, i32 %3, double 8.000000e-01)
  store i32 10, i32* %a, align 4
  %4 = load i32, i32* %ck, align 4
  %cmp = icmp eq i32 %4, 1
  br i1 %cmp, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %entry
  %5 = load i32, i32* %ck, align 4
...
if.end9:                                          ; preds = %if.then7, %lor.lhs.false
  %10 = bitcast [10 x [8 x i32]]* %c to i8*
